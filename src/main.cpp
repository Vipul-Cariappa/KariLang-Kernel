...
int main(int argc, char* argv[])
{
    ...
    {
        std::clog << "xkarilang " << KARILANG_VERSION  << std::endl;
        return 0;
    }
    ...
    // std* streams. When a user then tries to start a new kernel, xkarilang
    ...
    interpreter_ptr interpreter = interpreter_ptr(new karilang_kernel::interpreter());
